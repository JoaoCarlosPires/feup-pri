"""
Source: https://github.com/opensemanticsearch/lexemes

Import lexemes (dictionary including different grammar forms/lexical forms for each lexical entry) 
from Wikidata to Apache Solr synonym config
"""
